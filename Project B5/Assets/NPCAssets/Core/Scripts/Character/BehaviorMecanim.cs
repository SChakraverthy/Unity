...
public class BehaviorMecanim : MonoBehaviour
{
    ...
    #region myFunctions
    public Node Node_ConversationAnimation(Val<string> gestureName, Val<bool> start)
    {

        return new LeafInvoke(

            () => this.Character.ConversationAnimation(gestureName, start),
            () => this.Character.ConversationAnimation(gestureName, false));

    }

    public Node ST_PlayConversationGesture(Val<string> gestureName, Val<long> duration)
    {
        ...
        return new DecoratorCatch(
            ...
            new Sequence(
                ...
                Node_ConversationAnimation(gestureName, true),
                new LeafWait(duration),
                Node_ConversationAnimation(gestureName, false)));
