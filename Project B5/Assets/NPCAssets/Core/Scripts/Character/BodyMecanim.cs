...
public class BodyMecanim : MonoBehaviour
{
    ...
    private bool resettingConversationLayerWeight;
    ...
    void Update()
    {
        ...
        if (resettingConversationLayerWeight)
        {
            animator.SetLayerWeight(3, Mathf.Lerp(animator.GetLayerWeight(3), 0, Time.deltaTime));
        }
        if (this.nudge != null)
        {
    ...
    public void ResetAnimation()
    {
        ...
        this.animator.SetBool("ConvoAnimation", false);
    }
    #endregion
    ...
    #region myFunctions
    public void ConversationAnimation(string gestureName, bool isActive)
    {
        ...
        this.animator.SetBool("ConvoAnimation", isActive);

        //Layout1: "Conversation Layer". Weight needed in order to
        //run the animation.
        if (isActive)
        {
            this.animator.SetLayerWeight(3, 1);
            resettingConversationLayerWeight = false;
        } else
        {
            resettingConversationLayerWeight = true;
        }
        ...
        switch (gestureName.ToUpper())
        {
            ...
            case "TALK1":
                if (isActive)
                    this.animator.SetTrigger("C_Talk1");
                break;

            case "TALK2":
                if (isActive)
                    this.animator.SetTrigger("C_Talk2");
                break;

            case "YELL":
                if (isActive)
                    this.animator.SetTrigger("C_Yell");
                break;

            case "ARGUE1":
                if (isActive)
                    this.animator.SetTrigger("C_Argue1");
                break;

            case "ARGUE2":
                if (isActive)
                    this.animator.SetTrigger("C_Argue2");
                break;
        }
    }
