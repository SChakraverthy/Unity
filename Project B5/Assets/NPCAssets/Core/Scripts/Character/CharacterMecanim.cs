...
public class CharacterMecanim : MonoBehaviour
{
    ...
    #region myFunctions
    public virtual RunStatus ConversationAnimation(Val<string> gestureName, Val<bool> isActive)
    {
        this.Body.ConversationAnimation(gestureName.Value, isActive.Value);
        return RunStatus.Success;
    }
    #endregion
